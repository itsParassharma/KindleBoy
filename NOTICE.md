...
|-----------|-------|---------|
| Peanut-GB (`vendor/peanut_gb/peanut_gb.h`) | vendored | MIT — Copyright (c) 2018-2023 Mahyar Koshkouei |
...
legally-obtained dumps. `dmg-acid2` and Blargg's test ROMs (used only for
development) are freely distributed test software.
